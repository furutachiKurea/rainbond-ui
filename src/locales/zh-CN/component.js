...
const componentOverview = {
    ...
    'kubeblocks.database.check.detecting': '正在检测数据库集群...',
    'kubeblocks.database.check.success': '数据库集群创建成功',
    'kubeblocks.database.check.creating': '正在创建数据库集群...',
    ...
    'kubeblocks.database.backup.table.action': '操作',
    'kubeblocks.database.backup.table.delete': '删除',
    'kubeblocks.database.backup.delete.confirm': '确定要删除此备份吗？',
    'kubeblocks.database.backup.delete.confirm.ok': '确定',
    'kubeblocks.database.backup.delete.confirm.cancel': '取消',
    ...
    'componentOverview.kubeblocks.create.page.title': '创建数据库',
    'componentOverview.kubeblocks.create.page.subtitle': '使用 KubeBlocks 创建数据库集群，支持 PostgreSQL、MySQL、MongoDB 等多种数据库',
    'componentOverview.kubeblocks.create.tab.config': '数据库配置',
    'componentOverview.kubeblocks.create.button.next': '下一步',
    'componentOverview.kubeblocks.create.button.prev': '上一步',
    'componentOverview.kubeblocks.create.button.create': '创建数据库组件',
    'componentOverview.kubeblocks.create.form.database_type': '数据库类型',
    'componentOverview.kubeblocks.create.form.database_type.placeholder': '请选择数据库类型',
    'componentOverview.kubeblocks.create.form.database_type.required': '请选择数据库类型',
    'componentOverview.kubeblocks.create.check.detecting': '正在检测数据库集群...',
    'componentOverview.kubeblocks.create.check.success': '数据库集群创建成功',
    'componentOverview.kubeblocks.create.check.creating': '正在创建数据库集群...',

    // 数据库配置页面
    'componentOverview.kubeblocks.config.page.title': '数据库集群配置 - {service_name}',
    'componentOverview.kubeblocks.config.page.subtitle': '请根据业务需求配置数据库集群资源、备份等参数',

    // 基础信息配置
    'componentOverview.kubeblocks.basic.card.title': '基础信息设置',
    'componentOverview.kubeblocks.basic.memory.label': '内存',
    'componentOverview.kubeblocks.basic.memory.required': '请配置内存',
    'componentOverview.kubeblocks.basic.cpu.label': 'CPU',
    'componentOverview.kubeblocks.basic.cpu.required': '请配置CPU',
    'componentOverview.kubeblocks.basic.disk.label': '磁盘',
    'componentOverview.kubeblocks.basic.disk.required': '请配置磁盘大小',

    'componentOverview.kubeblocks.basic.replicas.label': '副本数',
    'componentOverview.kubeblocks.basic.replicas.required': '请配置副本数',
    'componentOverview.kubeblocks.basic.storage.label': '存储类',
    'componentOverview.kubeblocks.basic.storage.required': '请选择存储类',
    'componentOverview.kubeblocks.basic.version.label': '数据库版本',
    'componentOverview.kubeblocks.basic.version.required': '请选择数据库版本',
    ...
    // 备份配置
    'componentOverview.kubeblocks.backup.card.title': '备份配置',
    'componentOverview.kubeblocks.backup.repo.label': '备份仓库',
    'componentOverview.kubeblocks.backup.repo.placeholder': '请选择备份仓库',
    'componentOverview.kubeblocks.backup.repo.none': '不备份',
    'componentOverview.kubeblocks.backup.cycle.label': '备份周期',
    'componentOverview.kubeblocks.backup.cycle.hourly': '小时',
    'componentOverview.kubeblocks.backup.cycle.daily': '天',
    'componentOverview.kubeblocks.backup.cycle.weekly': '周',
    'componentOverview.kubeblocks.backup.startTime.label': '备份起始时间',
    'componentOverview.kubeblocks.backup.startTime.day.label': '星期',
    'componentOverview.kubeblocks.backup.startTime.hour.label': '小时',
    'componentOverview.kubeblocks.backup.startTime.minute.label': '分钟',
    'componentOverview.kubeblocks.backup.startTime.mon': '周一',
    'componentOverview.kubeblocks.backup.startTime.tue': '周二',
    'componentOverview.kubeblocks.backup.startTime.wed': '周三',
    'componentOverview.kubeblocks.backup.startTime.thu': '周四',
    'componentOverview.kubeblocks.backup.startTime.fri': '周五',
    'componentOverview.kubeblocks.backup.startTime.sat': '周六',
    'componentOverview.kubeblocks.backup.startTime.sun': '周日',
    'componentOverview.kubeblocks.backup.retention.label': '备份保留时间',
    'componentOverview.kubeblocks.backup.retention.unit': '天',
    'componentOverview.kubeblocks.backup.retention.placeholder': '请输入保留时间',
    'componentOverview.kubeblocks.backup.policy.label': '删除策略',
    'componentOverview.kubeblocks.backup.policy.delete': '删除',
    'componentOverview.kubeblocks.backup.policy.wipeout': '擦除',

    // 备份管理页面
    'componentOverview.kubeblocks.backup.page.title': '备份设置',
    'componentOverview.kubeblocks.backup.page.list.title': '备份列表',
    'componentOverview.kubeblocks.backup.page.manual.button': '手动备份',
    'componentOverview.kubeblocks.backup.table.name': '备份名称',
    'componentOverview.kubeblocks.backup.table.status': '备份状态',
    'componentOverview.kubeblocks.backup.table.time': '备份时间',
    'componentOverview.kubeblocks.backup.table.action': '操作',
    'componentOverview.kubeblocks.backup.table.delete': '删除',
    'componentOverview.kubeblocks.backup.status.completed': '已完成',
    'componentOverview.kubeblocks.backup.status.failed': '失败',
    'componentOverview.kubeblocks.backup.status.running': '运行中',
    'componentOverview.kubeblocks.backup.status.pending': '等待中',
    'componentOverview.kubeblocks.backup.delete.confirm': '确定要删除此备份吗？',
    'componentOverview.kubeblocks.backup.delete.success': '备份删除成功',
    'componentOverview.kubeblocks.backup.delete.failed': '备份删除失败',

    // 备份错误提示
    'componentOverview.kubeblocks.backup.error.repo': '请选择备份仓库',
    'componentOverview.kubeblocks.backup.error.cycle': '请选择备份周期',
    'componentOverview.kubeblocks.backup.error.retention': '请配置备份保留时间',
    'componentOverview.kubeblocks.backup.error.day': '请选择星期几进行备份',
    'componentOverview.kubeblocks.backup.error.hour': '请选择备份开始小时',
    'componentOverview.kubeblocks.backup.error.minute': '请选择备份开始分钟',

    // 数据库概览页面
    'componentOverview.kubeblocks.overview.title': '数据库概览',
    'componentOverview.kubeblocks.overview.instance.title': '数据库实例',

    // 数据库实例相关
    'kubeblocks.database.instance.loading': '加载中...',
    'kubeblocks.database.instance.total': '总实例数',
    'kubeblocks.database.instance.running': '运行中',
    'kubeblocks.database.instance.ready': '就绪',
    'kubeblocks.database.instance.clusterStatus': '集群状态',
    'kubeblocks.database.instance.list': '实例列表',
    'kubeblocks.database.instance.noInstances': '暂无实例',
    'kubeblocks.database.instance.clusterInfo': '集群信息',
    'kubeblocks.database.instance.clusterName': '集群名称',
    'kubeblocks.database.instance.databaseType': '数据库类型',
    'kubeblocks.database.instance.version': '版本',
    'componentOverview.kubeblocks.overview.storage.label': '存储使用量',
    'componentOverview.kubeblocks.overview.memory.label': '内存',
    // 数据库扩容页面
    'componentOverview.kubeblocks.expansion.title': '数据库扩容',
    'componentOverview.kubeblocks.expansion.telescopic': '手动伸缩',
    'componentOverview.kubeblocks.expansion.memory.label': '内存',
    'componentOverview.kubeblocks.expansion.cpu.label': 'CPU',
    'componentOverview.kubeblocks.expansion.replicas.label': '副本数量',
    'componentOverview.kubeblocks.expansion.storage.label': '存储容量',
    'componentOverview.kubeblocks.expansion.modify': '如需修改伸缩模式，请',
    'componentOverview.kubeblocks.expansion.set': '设置应用模式',

    // 通用术语库
    'componentOverview.kubeblocks.common.database': '数据库',
    'componentOverview.kubeblocks.common.cluster': '集群',
    'componentOverview.kubeblocks.common.instance': '实例',
    'componentOverview.kubeblocks.common.backup': '备份',
    'componentOverview.kubeblocks.common.repository': '仓库',
    'componentOverview.kubeblocks.common.configuration': '配置',
    'componentOverview.kubeblocks.common.monitoring': '监控',
    'componentOverview.kubeblocks.common.resources': '资源',
